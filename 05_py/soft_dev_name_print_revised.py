...
# Discoveries: Although I knew how to read files in Python, it hadn't occured
# to me that it would be a good idea to store the student names in text files.
